...
export const episodesApi = {
  list: (params?: any) => api.get('/treatment-episodes', { params }),
  get: (id: number) => api.get(`/treatment-episodes/${id}`),
  create: (data: any) => api.post('/treatment-episodes', data),
  update: (id: number, data: any) => api.patch(`/treatment-episodes/${id}`, data),
  delete: (id: number) => api.delete(`/treatment-episodes/${id}`),
  confirm: (id: number) => api.post(`/treatment-episodes/${id}/confirm`),
  cancel: (id: number, reason?: string) => api.post(`/treatment-episodes/${id}/cancel`, { cancellation_reason: reason }),
  complete: (id: number, notes?: string) => api.post(`/treatment-episodes/${id}/complete`, { notes }),
  sendReminder: (id: number) => api.post(`/treatment-episodes/${id}/send-reminder`),
};
...
export const imagingApi = {
  list: (params?: any) => api.get('/medical-reports', { params }),
  get: (id: number) => api.get(`/medical-reports/${id}`),
  create: (data: FormData) => api.post('/medical-reports', data, { headers: { 'Content-Type': 'multipart/form-data' } }),
  update: (id: number, data: any) => api.patch(`/medical-reports/${id}`, data),
  delete: (id: number) => api.delete(`/medical-reports/${id}`),
  approve: (id: number) => api.post(`/medical-reports/${id}/approve`),
  reject: (id: number, reason?: string) => api.post(`/medical-reports/${id}/reject`, { reason }),
  retry: (id: number) => api.post(`/medical-reports/${id}/retry`),
};
