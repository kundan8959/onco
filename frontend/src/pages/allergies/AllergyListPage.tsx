...
export default function AllergyListPage() {
  ...
  const fetchData = useCallback(async () => {
    const res = await allergiesApi.list({ page, page_size: pageSize, ...(severityFilter ? { severity: severityFilter } : {}) });
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <button className="btn btn-primary" onClick={() => setOpen(true)}><i className="fas fa-plus"></i> Add Allergy</button>
      </div>
            ...
            {items.map((a: any) => (
              <tr key={a.id}>
                ...
                <td className="actions">
                  <button onClick={() => handleEdit(a)} className="btn btn-sm btn-warning" title="Edit"><i className="fas fa-edit"></i></button>
                  <button onClick={() => handleDelete(a.id)} className="btn btn-sm btn-danger" title="Delete"><i className="fas fa-trash"></i></button>
                </td>
              </tr>
            ))}
