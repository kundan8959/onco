  ...
  return (
    <div>
      ...
      <div className="module-intro-card">
        <div>
          <span className="eyebrow">Operational schedule</span>
          <h3>Daily treatment board with direct actions.</h3>
          <p>Reschedule, delay, and complete treatment sessions directly from the board instead of playing ping-pong with generic edit forms.</p>
        </div>
