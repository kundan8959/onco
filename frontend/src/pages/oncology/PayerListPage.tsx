...
export default function PayerListPage() {
  ...
  return (
    <div>
      <div className="page-header"><h2 className="page-title"><i className="fas fa-file-invoice-dollar"></i> Payer Submission</h2><button className="btn btn-primary" onClick={() => setOpen(true)}><i className="fas fa-plus"></i> New Claim / Auth Request</button></div>
      <div className="module-intro-card revenue-card"><div><span className="eyebrow">Revenue-critical module</span><h3>Payer Submission drives the reimbursement workflow.</h3><p>Use this module for claims, prior authorization requests, and payer follow-up. This should stay central to the oncology revenue model.</p></div><div className="metric-chip-row"><span className="metric-chip success">Approved claims</span><span className="metric-chip info">Submitted packets</span><span className="metric-chip warning">Auth pending</span></div></div>
