...
export const appRoutes: RouteConfig[] = [
  ...
  { path: 'patient/chemo-schedule', label: 'My Episodes', roles: ['patient'], title: 'My Episodes', subtitle: 'All your scheduled sessions — chemotherapy, radiation, immunotherapy, and more.', heroTitle: 'Your full treatment schedule in one place', heroText: 'View, download, and prepare for all your upcoming treatment sessions — chemotherapy, radiation, targeted therapy, and more.', metrics: [{ label: 'Upcoming Sessions', value: '2', tone: 'blue' }, { label: 'Completed', value: '6', tone: 'green' }, { label: 'Requirements Pending', value: '1', tone: 'amber' }, { label: 'Missed Sessions', value: '0', tone: 'purple' }], panels: [{ title: 'Episode Types', items: ['Chemotherapy', 'Radiation Therapy', 'Immunotherapy', 'Targeted Therapy', 'Surgery', 'Consultation', 'Follow-up Visit'] }, { title: 'Patient Help', items: ['Arrival reminders', 'Checklist visibility', 'Location/time clarity', 'Download schedule'] }], actions: ['View Calendar', 'Download Schedule', 'Prepare for Visit'] },
