...
export default function MedicationListPage() {
  ...
  const fetchData = useCallback(async () => {
    const res = await medicationsApi.list({ page, page_size: pageSize, ...(activeFilter !== '' ? { is_active: activeFilter } : {}) });
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <button className="btn btn-primary" onClick={() => setOpen(true)}><i className="fas fa-plus"></i> Add Medication</button>
      </div>
            ...
            {items.map((m: any) => (
              <tr key={m.id}>
                ...
                <td className="actions">
                  <button onClick={() => handleEdit(m)} className="btn btn-sm btn-warning"><i className="fas fa-edit"></i></button>
                  <button onClick={() => handleDelete(m.id)} className="btn btn-sm btn-danger"><i className="fas fa-trash"></i></button>
                </td>
              </tr>
            ))}
