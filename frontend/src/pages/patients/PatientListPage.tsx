  ...
  return (
    <div>
      <div className="page-header">
        ...
        <Link to="/patients/add" className="btn btn-primary"><i className="fas fa-plus"></i> Add Patient</Link>
      </div>
            ...
            {patients.map((p: any) => (
              <tr key={p.id}>
                ...
                <td className="actions">
                  ...
                  <Link to={`/patients/${p.id}/edit`} className="btn btn-sm btn-warning" title="Edit"><i className="fas fa-edit"></i></Link>
                  <button onClick={() => handleDelete(p.id)} className="btn btn-sm btn-danger" title="Delete"><i className="fas fa-trash"></i></button>
                </td>
              </tr>
            ))}
            {patients.length === 0 && (
