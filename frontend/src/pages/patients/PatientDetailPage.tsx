    ...
    <div>
      <div className="patient-hero-card">
        <div>
          ...
          <p>Clinical profile, patient context, medications, vitals, allergies, chronic conditions, and family history in one workspace.</p>
        ...
        <div className="hero-actions">
          <Link to={`/patients/${id}/edit`} className="btn btn-warning"><i className="fas fa-edit"></i> Edit</Link>
          <button onClick={() => { if (window.confirm('Delete?')) patientsApi.delete(Number(id)).then(() => navigate('/patients')); }} className="btn btn-danger ml-2">
