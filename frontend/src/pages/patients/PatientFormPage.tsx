    ...
    <div>
      <div className="patient-hero-card compact-hero-card">
        <div>
          ...
          <h1>{isEdit ? 'Edit patient profile' : 'Create patient profile'}</h1>
          <p>Capture the core patient profile used by the current backend API. Extra demographic and emergency-contact fields can be added back once the create/update DTOs are expanded.</p>
        </div>
      </div>
