...
export default function VitalsListPage() {
  ...
  const fetchData = useCallback(async () => {
    const res = await vitalsApi.list({ page, page_size: pageSize });
