  ...
  return (
    <div>
      ...
      <div className="module-intro-card">
        <div>
          <span className="eyebrow">Superadmin · Users</span>
          <h3>Real account CRUD across superadmin, hospital, and patient roles.</h3>
          <p>Create accounts, adjust roles, assign hospital context, and deactivate access. Finally useful. Wild concept.</p>
        </div>
