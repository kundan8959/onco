  ...
  return (
    <div>
      ...
      <div className="module-intro-card">
        <div>
          <span className="eyebrow">Superadmin · Analytics</span>
          <h3>Live cohort analytics with filters, export, and trend blocks.</h3>
          <p>Date and hospital slices are now exposed in the UI so this page stops pretending the only valid question is “show me all the things forever.”</p>
        </div>
