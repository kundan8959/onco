...
export class UpdatePatientDto {
  ...
  @IsOptional() @IsString() gender_other?: string;
  ...
  @IsOptional() @IsString() emergency_contact_email?: string;
  @IsOptional() @IsString() emergency_contact_name_relation?: string;
  @IsOptional() @IsString() street_address?: string;
  @IsOptional() @IsString() street_address_line2?: string;
