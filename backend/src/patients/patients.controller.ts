...
export class PatientsController {
  ...
  findOnePatient(@Param('id', ParseIntPipe) id: number) {
    return this.svc.findOnePatient(id);
  }
  ...
  findAllAllergies(@Query() query: any) {
    return this.svc.findAllAllergies(query);
  }
  ...
  findAllVitals(@Query() query: any) {
    return this.svc.findAllVitals(query);
  }
  ...
  findAllLifestyle(@Query() query: any) {
    return this.svc.findAllLifestyle(query);
  }
  ...
  findAllMedicalHistory(@Query() query: any) {
    return this.svc.findAllMedicalHistory(query);
  }
  ...
  findAllMedications(@Query() query: any) {
    return this.svc.findAllMedications(query);
  }
  ...
  findAllConditions(@Query() query: any) {
    return this.svc.findAllConditions(query);
  }
